...
run_manual_test_command "perf record -o $GLIBC_PERF_DATA $GLIBC_BUILD $TEST_NUM > /dev/null 2>&1"
run_manual_test_command "perf record -o $MUSL_PERF_DATA $MUSL_BUILD $TEST_NUM > /dev/null 2>&1"
run_manual_test_command "perf diff $GLIBC_PERF_DATA $MUSL_PERF_DATA"
