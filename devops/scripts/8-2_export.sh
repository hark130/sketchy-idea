...
# This script was made to help automate exporting 8-2's output into a single
...
# 5. Misc.
# 5.A. test_sa_read_cpu_tsc
printf "%s Executing manual test code %s\n" "$BOOKEND" "$BOOKEND"
