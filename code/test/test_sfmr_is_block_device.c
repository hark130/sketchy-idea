/*
 *	Manually test skid_file_metadata_read.h's is_block_device() function.
 *
 *	Copy/paste the following...

mkfifo ./code/test/test_input/named_pipe
./code/dist/test_sfmr_is_block_device.bin ./code/test/test_input/regular_file.txt  # No
./code/dist/test_sfmr_is_block_device.bin ./code/test/test_input/                  # No
./code/dist/test_sfmr_is_block_device.bin ./code/test/test_input/sym_link.txt      # No
./code/dist/test_sfmr_is_block_device.bin ./code/test/test_input/named_pipe        # No
./code/dist/test_sfmr_is_block_device.bin /dev/null                                # No, char device
./code/dist/test_sfmr_is_block_device.bin /dev/loop0                               # Yes
...
#include "skid_file_metadata_read.h"  // is_block_device()
