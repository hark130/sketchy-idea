...
./code/dist/test_sfmr_get_file_metadata.bin /dev/loop0                               # Block device
./code/dist/test_sfmr_get_file_metadata.bin /dev/null                                # Char device
./code/dist/test_sfmr_get_file_metadata.bin ./code/test/test_input/                  # Directory
./code/dist/test_sfmr_get_file_metadata.bin ./code/test/test_input/regular_file.txt  # Regular file
./code/dist/test_sfmr_get_file_metadata.bin /var/run/dbus/system_bus_socket          # Socket
./code/dist/test_sfmr_get_file_metadata.bin ./code/test/test_input/sym_link.txt      # Sym link
