...
make -C code dist/check_sfmr_get_file_device_id.bin
code/dist/check_sfmr_get_file_device_id.bin && CK_FORK=no valgrind --leak-check=full --show-leak-kinds=all code/dist/check_sfmr_get_file_device_id.bin
