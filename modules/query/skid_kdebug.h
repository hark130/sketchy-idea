...
#define HARKLE_KERROR(module, funcName, errMsg) do { printk(KERN_ERR "%s: %s %s - %s\n", DEBUG_ERROR_STR, module, #funcName, errMsg); } while (0);
#define HARKLE_KERRNO(module, funcName, errNum) do { printk(KERN_ERR "%s: %s %s() returned errno: %d!\n", DEBUG_ERROR_STR, module, #funcName, errNum); } while (0);
#define HARKLE_KWARNG(module, funcName, warnMsg) do { printk(KERN_WARNING "%s: %s %s() - %s!\n", DEBUG_WARNG_STR, module, #funcName, warnMsg); } while (0);
#define HARKLE_KFINFO(module, funcName, msg) do { printk(KERN_INFO "%s: %s %s - %s\n", DEBUG_INFO_STR, module, #funcName, msg); } while (0);
#define HARKLE_KINFO(module, msg) do { printk(KERN_INFO "%s: %s %s\n", DEBUG_INFO_STR, module, msg); } while (0);
#else
